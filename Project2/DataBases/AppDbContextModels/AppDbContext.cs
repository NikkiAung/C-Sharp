...
public partial class AppDbContext : DbContext
{
    ...
    public virtual DbSet<TblWallletHistory> TblWallletHistories { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TblWallet>(entity =>
        {
            ...
            entity.Property(e => e.MobileNo)
                .HasMaxLength(50)
                .IsUnicode(false);
            entity.Property(e => e.WallletUserName)
                .HasMaxLength(50)
                .IsUnicode(false);
        });

        modelBuilder.Entity<TblWallletHistory>(entity =>
        {
            entity.HasKey(e => e.WalletHistoryId);

            entity.ToTable("Tbl_WallletHistory");
